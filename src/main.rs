...
use adw::{Application, ApplicationWindow, HeaderBar, ColorScheme, StyleManager};
use adw::gio::MenuModel;
use gtk::{Builder, Button, Orientation, Paned, Picture, PopoverMenuBar, Scrollable, Separator, TextView, Widget};
use gtk::{CssProvider, ScrollablePolicy, ScrolledWindow, StyleContext};
...
fn build_from_xml(app: &Application) {
    ...
    let builder = Builder::from_file("res/ui/main.ui");
